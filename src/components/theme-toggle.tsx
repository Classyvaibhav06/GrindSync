...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      {/* Sliding capsule */}
      <span className="theme-toggle-capsule" aria-hidden>
      ...
      {/* Labels */}
      <span className="theme-toggle-label theme-toggle-label--dark" aria-hidden>
      ...
      <span className="theme-toggle-label theme-toggle-label--light" aria-hidden>
        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.7 }}>
          <circle cx="12" cy="12" r="5" />
          <line x1="12" y1="1" x2="12" y2="3" />
          <line x1="12" y1="21" x2="12" y2="23" />
